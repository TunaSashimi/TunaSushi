...
public class SVGTool {
    ...
    public static SVG getSVGFromInputStream(InputStream svgData) throws SVGParseException {
        return SVGTool.parse(svgData, 0, 0, false);
    }
    ...
    public static SVG getSVGFromInputStream(InputStream svgData, int targetWidth, int targetHeight)
            throws SVGParseException {
        return SVGTool.parse(svgData, 0, 0, false, targetWidth, targetHeight);
    }
    ...
    public static SVG getSVGFromResource(Resources resources, int resId) throws SVGParseException {
        return SVGTool.parse(resources.openRawResource(resId), 0, 0, false);
    }
    ...
    public static SVG getSVGFromInputStream(InputStream svgData, int searchColor, int replaceColor,
        ...
        return SVGTool.parse(svgData, searchColor, replaceColor, false, targetWidth, targetHeight);
    }
    ...
    public static SVG getSVGFromString(String svgData, int searchColor, int replaceColor) throws SVGParseException {
        return SVGTool.parse(new ByteArrayInputStream(svgData.getBytes()), searchColor, replaceColor, false);
    }
    ...
    public static SVG getSVGFromResource(Resources resources, int resId, int searchColor, int replaceColor) throws SVGParseException {
        return SVGTool.parse(resources.openRawResource(resId), searchColor, replaceColor, false);
    }
    ...
    private static Path doPath(String s) {
        int n = s.length();
        SVGToolHelper ph = new SVGToolHelper(s, 0);
        ph.skipWhitespace();
        Path p = new Path();
        float lastX = 0;
        float lastY = 0;
...
//            Log.d(TAG, "Float parsing '" + name + "=" + v + "'");
    ...
    //
    static class SVGParseException extends RuntimeException {
    ...
    public static class SVGToolHelper {
        ...
        public SVGToolHelper(CharSequence s, int pos) {
            this.s = s;
            this.pos = pos;
            n = s.length();

	...
	protected void onDraw(Canvas canvas){
		...
		if (rippleInnerCircleRadius > 0) {
			...
			canvas.drawCircle(width >> 1, height >> 1, rippleInnerCircleRadius,
					PaintTool.initPaint(Paint.Style.FILL, rippleInnerCircleColor, rippleInnerCircleColorShader));
		}
		...
		if (rippleOuterCircleRadius > rippleInnerCircleRadius && rippleOuterCircleRadius < rippleMaxRadius) {
			canvas.drawCircle(
					...
					PaintTool.initPaint(Paint.Style.FILL, rippleOuterCircleColor, rippleInnerCircleColorShader, (int) ((rippleMaxRadius - rippleOuterCircleRadius)
		...
		if (rippleOuterDelayCircleRadius > rippleInnerCircleRadius && rippleOuterDelayCircleRadius < rippleMaxRadius) {
			canvas.drawCircle(
					...
					PaintTool.initPaint(Paint.Style.FILL, rippleOuterCircleColor, rippleOuterCircleColorShader, (int) ((rippleMaxRadius - rippleOuterDelayCircleRadius)
							/ rippleDeltaRadius * 255)));
		}
		if (rippleOuterDeferCircleRadius > rippleInnerCircleRadius && rippleOuterDeferCircleRadius < rippleMaxRadius) {
			canvas.drawCircle(
					...
					PaintTool.initPaint(Paint.Style.FILL, rippleOuterCircleColor, rippleOuterCircleColorShader, (int) ((rippleMaxRadius - rippleOuterDeferCircleRadius)
							/ rippleDeltaRadius * 255)));
		}

		if (rippleTextValue != null) {
			drawText(canvas, rippleTextValue, width, (width >> 1) + rippleTextDx, (height >> 1) + rippleTextDy, 0, 0,
					PaintTool.initTextPaint(Paint.Style.FILL, rippleTextColor, rippleTextSize, Align.CENTER));
		}
	}
